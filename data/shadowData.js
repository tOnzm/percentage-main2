...
window.shadowData = {
  "Basic Shadows": [
    ...
    {
      label: "Soft Elegant",
      val: "soft elegant shadows, barely visible",
    },
    {
  ...
  "Pattern Shadows": [
      { label: "Sharp Editorial", val: "sharp clean editorial shadows, Rembrandt triangle contrast, Chiaroscuro lighting effect with defined shadow edges" },
      { label: "Long Cinematic", val: "long cinematic projected shadows, dramatic noir aesthetic, extended shadow stretching across frame, filmic mood" },
    {
